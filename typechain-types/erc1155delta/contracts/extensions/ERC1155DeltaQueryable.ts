...
export interface ERC1155DeltaQueryableInterface extends utils.Interface {
  functions: {
...
export interface ERC1155DeltaQueryable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155DeltaQueryableInterface;
