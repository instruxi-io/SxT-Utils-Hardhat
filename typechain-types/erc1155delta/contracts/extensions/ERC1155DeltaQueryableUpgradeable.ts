...
export interface ERC1155DeltaQueryableUpgradeableInterface
...
export interface ERC1155DeltaQueryableUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155DeltaQueryableUpgradeableInterface;
