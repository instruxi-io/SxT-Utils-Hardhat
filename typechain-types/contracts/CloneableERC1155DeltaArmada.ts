...
export interface CloneableERC1155DeltaArmadaInterface extends utils.Interface {
  functions: {
    ...
    "armadaToFleetAddress(uint256)": FunctionFragment;
    ...
    "setFleetAddress(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "armadaToFleetAddress",
  ...
  encodeFunctionData(
    functionFragment: "setFleetAddress",
  ...
  events: {
    ...
    "SetFleetAddressToArmada(uint256,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetFleetAddressToArmada"): EventFragment;
...
export interface SetFleetAddressToArmadaEventObject {
  armadaTokenId: BigNumber;
  fleetAddress: string;
}
export type SetFleetAddressToArmadaEvent = TypedEvent<
  [BigNumber, string],
  SetFleetAddressToArmadaEventObject
>;

export type SetFleetAddressToArmadaEventFilter =
  TypedEventFilter<SetFleetAddressToArmadaEvent>;
...
export interface CloneableERC1155DeltaArmada extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CloneableERC1155DeltaArmadaInterface;
  ...
  functions: {
    ...
    setFleetAddress(
      armadaTokenId: PromiseOrValue<BigNumberish>,
      fleetAddress: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "SetFleetAddressToArmada(uint256,address)"(
      armadaTokenId?: null,
      fleetAddress?: null
    ): SetFleetAddressToArmadaEventFilter;
    SetFleetAddressToArmada(
      armadaTokenId?: null,
      fleetAddress?: null
    ): SetFleetAddressToArmadaEventFilter;
